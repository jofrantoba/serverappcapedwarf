...
public abstract class CharMatcher implements Predicate<Character> {
  ...
  // MOE:insert /**
  // MOE:insert  * Determines whether a character is whitespace according to the latest Unicode
  // MOE:insert  * standard, as illustrated
  // MOE:insert  * <a href="http://unicode.org/cldr/utility/list-unicodeset.jsp?a=%5Cp%7Bwhitespace%7D">here</a>.
  // MOE:insert  * This is not the same definition used by other Java APIs. (See a
  // MOE:insert  * <a href="http://spreadsheets.google.com/pub?key=pd8dAQyHbdewRsnE5x5GzKQ">
  // MOE:insert  * comparison of several definitions of "whitespace"</a>.)
  // MOE:insert  *
  // MOE:insert  * <p><b>Note:</b> as the Unicode definition evolves, we will modify this constant
  // MOE:insert  * to keep it up to date.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #whitespace()} instead. This constant is scheduled to be
  // MOE:insert  *     removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher WHITESPACE = whitespace();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is a breaking whitespace (that is, a whitespace
  // MOE:insert  * which can be interpreted as a break between words for formatting purposes). See
  // MOE:insert  * {@link #whitespace} for a discussion of that term.
  // MOE:insert  *
  // MOE:insert  * @since 2.0
  // MOE:insert  * @deprecated Use {@link #breakingWhitespace()} instead. This constant is scheduled
  // MOE:insert  *     to be removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher BREAKING_WHITESPACE = breakingWhitespace();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is ASCII, meaning that its code point is less than
  // MOE:insert  * 128.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #ascii()} instead. This constant is scheduled to be
  // MOE:insert  *     removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher ASCII = ascii();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is a digit according to
  // MOE:insert  * <a href="http://unicode.org/cldr/utility/list-unicodeset.jsp?a=%5Cp%7Bdigit%7D">
  // MOE:insert  * Unicode</a>. If you only care to match ASCII digits, you can use
  // MOE:insert  * {@code inRange('0', '9')}.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #digit()} instead. This constant is scheduled to be
  // MOE:insert  *     removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher DIGIT = digit();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is a digit according to
  // MOE:insert  * {@linkplain Character#isDigit(char) Java's definition}. If you only care to match
  // MOE:insert  * ASCII digits, you can use {@code inRange('0', '9')}.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #javaDigit()} instead. This constant is scheduled to be
  // MOE:insert  *     removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher JAVA_DIGIT = javaDigit();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is a letter according to
  // MOE:insert  * {@linkplain Character#isLetter(char) Java's definition}. If you only care to
  // MOE:insert  * match letters of the Latin alphabet, you can use
  // MOE:insert  * {@code inRange('a', 'z').or(inRange('A', 'Z'))}.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #javaLetter()} instead. This constant is scheduled to be
  // MOE:insert  *     removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher JAVA_LETTER = javaLetter();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is a letter or digit according to
  // MOE:insert  * {@linkplain Character#isLetterOrDigit(char) Java's definition}.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #javaLetterOrDigit()} instead. This constant is scheduled
  // MOE:insert  *     to be removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher JAVA_LETTER_OR_DIGIT = javaLetterOrDigit();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is upper case according to
  // MOE:insert  * {@linkplain Character#isUpperCase(char) Java's definition}.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #javaUpperCase()} instead. This constant is scheduled to
  // MOE:insert  *     be removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher JAVA_UPPER_CASE = javaUpperCase();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is lower case according to
  // MOE:insert  * {@linkplain Character#isLowerCase(char) Java's definition}.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #javaLowerCase()} instead. This constant is scheduled to
  // MOE:insert  *     be removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher JAVA_LOWER_CASE = javaLowerCase();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is an ISO control character as specified by
  // MOE:insert  * {@link Character#isISOControl(char)}.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #javaIsoControl()} instead. This constant is scheduled to
  // MOE:insert  *     be removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher JAVA_ISO_CONTROL = javaIsoControl();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is invisible; that is, if its Unicode category is
  // MOE:insert  * any of SPACE_SEPARATOR, LINE_SEPARATOR, PARAGRAPH_SEPARATOR, CONTROL, FORMAT,
  // MOE:insert  * SURROGATE, and PRIVATE_USE according to ICU4J.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #invisible()} instead. This constant is scheduled to be
  // MOE:insert  *     removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher INVISIBLE = invisible();

  // MOE:insert /**
  // MOE:insert  * Determines whether a character is single-width (not double-width). When in doubt,
  // MOE:insert  * this matcher errs on the side of returning {@code false} (that is, it tends to
  // MOE:insert  * assume a character is double-width).
  // MOE:insert  *
  // MOE:insert  * <p><b>Note:</b> as the reference file evolves, we will modify this constant to
  // MOE:insert  * keep it up to date.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #singleWidth()} instead. This constant is scheduled to be
  // MOE:insert  *     removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher SINGLE_WIDTH = singleWidth();

  // MOE:insert /**
  // MOE:insert  * Matches any character.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #any()} instead. This constant is scheduled to be
  // MOE:insert  *     removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher ANY = any();

  // MOE:insert /**
  // MOE:insert  * Matches no characters.
  // MOE:insert  *
  // MOE:insert  * @deprecated Use {@link #none()} instead. This constant is scheduled to be
  // MOE:insert  *     removed in June 2018.
  // MOE:insert  */
  // MOE:insert @Deprecated
  // MOE:insert public static final CharMatcher NONE = none();
