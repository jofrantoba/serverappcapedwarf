...
public final class Lists {
   ...
   * benchmarking your specific needs, use one of those instead.
   *
   * <p>Note that even when you do need exactly what this method does, it still
   * provides only a tiny bit of syntactic sugar for {@code
   * newLinkedList(}{@link Arrays#asList asList}{@code (...))}, or for creating
   * an empty list then calling {@link Collections#addAll}. This method is not
   * actually very useful and will likely be deprecated in the future.
   */
  @SafeVarargs
  @GwtCompatible(serializable = true)
  @GoogleInternal // pending removal for being not very useful
